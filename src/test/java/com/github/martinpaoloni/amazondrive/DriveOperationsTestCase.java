package com.github.martinpaoloni.amazondrive;
...
public class DriveOperationsTestCase extends MuleArtifactFunctionalTestCase {
  ...
  public void executeSayHiOperation() throws Exception {
    String payloadValue = ((String) flowRunner("sayHiFlow").run()
                                      ...
                                      .getPayload()
                                      .getValue());
    assertThat(payloadValue, is("Hello Martin Paoloni!!!"));
  }
